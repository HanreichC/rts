...
public partial class HexTileBase : Node3DBase
{
	...
	public override void _Ready()
	{
		...
		BuildGeometry();
		Position += new Vector3(0, -GetLocalBottomY(), 0);
		...
		ConstructionSite.Position = new Vector3(0, SurfaceHeight - ConstructionSite.GetLocalBottomY(), 0);
	...
	private void AddBuilding(BuildingBase building)
	{
		...
		try
		{
			...
			Building = building;
			Building.Position = new Vector3(0, SurfaceHeight - Building.GetLocalBottomY(), 0);
			Building.RotationDegrees = new Vector3(0, new Random().Next(6) * 60f, 0);
